...
void setup(void) {
    ...
    if (g_identifier == 0xEFEF) g_identifier = 0x9486; // write-only shield
    if (g_identifier == 0xD3D3) g_identifier = 0x9481; // write-only shield
    if (g_identifier == 0x0101) g_identifier = 0x1581; // write-only shield
    if (g_identifier == 0x2121) g_identifier = 0x1581; // write-only shield
